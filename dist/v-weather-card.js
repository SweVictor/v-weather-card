...
class $19fe8e3abedf4df0$export$c7c07a37856565d extends HTMLElement {
    ...
    requestUpdate(t, s, i, e = !1, r) {
        if (void 0 !== t) {
            if (i ??= this.constructor.getPropertyOptions(t), !(i.hasChanged ?? $19fe8e3abedf4df0$export$53a6892c50694894)(e ? r : this[t], s)) return;
            this.C(t, s, i);
        }
...
}), ($19fe8e3abedf4df0$var$a.reactiveElementVersions ??= []).push("2.0.0");
...
class $f58f44579a4747ac$var$M {
    ...
    _(t) {
        this._$AH !== $f58f44579a4747ac$export$45b790e32b2810ee && $f58f44579a4747ac$var$c(this._$AH) ? this._$AA.nextSibling.data = t : this.$($f58f44579a4747ac$var$r.createTextNode(t)), this._$AH = t;
    }
    g(t) {
    ...
    T(t) {
        ...
        const i = this._$AH;
        let s, e = 0;
        for (const h of t)e === i.length ? i.push(s = new $f58f44579a4747ac$var$M(this.k($f58f44579a4747ac$var$l()), this.k($f58f44579a4747ac$var$l()), this, this.options)) : s = i[e], s._$AI(h), e++;
...
const $a399cc6bbb0eb26a$var$weatherIconsDay = {
    clear: "day",
    "clear-night": "night",
    cloudy: "cloudy",
    fog: "cloudy",
...
const $a399cc6bbb0eb26a$var$weatherIconsNight = {
    ...$a399cc6bbb0eb26a$var$weatherIconsDay,
    clear: "night",
    sunny: "night",
    partlycloudy: "cloudy-night-3",
    "windy-variant": "cloudy-night-3"
};
const $a399cc6bbb0eb26a$var$windDirections = [
    "N",
    "NNE",
    "NE",
    "ENE",
...
let $a399cc6bbb0eb26a$export$2564da1f4cc8e8b4 = class VWeatherCard extends (0, $ab210b2da7b39b9d$export$3f2f9f5909897157) {
    ...
    setConfig(config) {
        ...
        if (!config.entity) // If no entity was specified, this will display a red error card with the message below
...
class $d067581fc0d59830$export$428b02af6307b05 extends (0, $ab210b2da7b39b9d$export$3f2f9f5909897157) {
    ...
    static #_ = this.styles = (0, $def2de46b9306e8a$export$dbf350e5966cf602)`
    .table {
      display: table;
    }
    .row {
...
//# sourceMappingURL=v-weather-card.js.map
